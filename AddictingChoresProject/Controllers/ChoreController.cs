...
namespace AddictingChoresProject.Controllers
{
    public class ChoreController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ChoreId,Value,ValueType,Description,Assignment,StartDate,DeadlineDate,ChoreTitle")] Chore chore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChoreId,Value,ValueType,Description,Assignment,StartDate,DeadlineDate,ChoreTitle")] Chore chore)
        {
            if (ModelState.IsValid)
            {
